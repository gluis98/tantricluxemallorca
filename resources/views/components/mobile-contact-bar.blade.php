@php $locale = $locale ?? 'es';
    $waPhone = '34602560426';
    $waMsg = rawurlencode(trans('contactPage.whatsapp_default_message', [], $locale));
    $waMeUrl = "https://wa.me/{$waPhone}?text={$waMsg}";
@endphp
...
>
    ...
    <div class="grid grid-cols-2 gap-1 w-full">
        ...
        >
            ...
            <span class="text-[10px] font-medium uppercase tracking-wide text-center leading-tight">{{ trans('contactPage.mobile_bar_call', [], $locale) }}</span>
        </a>
        ...
        >
            ...
            <span class="text-[10px] font-medium uppercase tracking-wide text-center leading-tight">{{ trans('contactPage.mobile_bar_whatsapp', [], $locale) }}</span>
        </a>
