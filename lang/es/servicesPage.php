...
return array (
  ...
  array (
    ...
    array (
      ...
      'meta_title' => 'Masaje Cuerpo a Cuerpo Palma | Experiencia Sensual Íntima Mallorca',
      'meta_description' => 'Masaje cuerpo a cuerpo en Palma de Mallorca. Contacto piel con piel, movimientos envolventes y conexión profunda. Desde 80€. Reserva ahora.',
      'meta_keywords' => 'masaje cuerpo a cuerpo palma, masaje piel con piel mallorca, masaje sensual palma, masaje intimo mallorca, masaje erotico cuerpo cuerpo palma',
      'features' => array ( 0 => 'Contacto piel con piel', 1 => 'Movimientos suaves y envolventes', 2 => 'Conexión sensorial profunda', 3 => 'Relajación y bienestar' ),
      'fullDescription' => 'Una experiencia íntima y sensorial donde el contacto piel con piel crea una conexión especial entre los cuerpos. A través de movimientos suaves, fluidos y envolventes, este masaje se realiza cuerpo a cuerpo y con desnudos, despertando los sentidos y generando una sensación profunda de relajación, sensualidad y bienestar. Opciones: 30 min – 80€ | 45 min – 120€ | 60 min – 150€.',
      'image' => '/images/sensual_premium.webp',
    ),
    2 =>
    array (
      'id' => 3,
      'slug' => 'experiencia-erotica-ducha',
      ...
      'meta_title' => 'Experiencia Erótica en la Ducha Palma | Placer Sensorial bajo el Agua Mallorca',
      'meta_description' => 'Experiencia erótica en la ducha en Palma de Mallorca. Ambiente cálido, caricias suaves y cercanía del cuerpo bajo el agua. 60 min – 200€. Reserva ahora.',
      'meta_keywords' => 'experiencia erotica ducha palma, masaje ducha mallorca, ducha erotica palma, experiencia sensual ducha mallorca, masaje bajo agua palma',
      'features' => array ( 0 => 'Ambiente cálido bajo el agua', 1 => 'Contacto cercano y sensorial', 2 => 'Caricias suaves y envolventes', 3 => 'Atmósfera de placer y conexión' ),
      'fullDescription' => 'Una experiencia íntima y sensorial bajo el agua, donde el ambiente cálido y el contacto cercano crean un momento de profunda relajación y sensualidad. La combinación del agua, las caricias suaves y la cercanía del cuerpo despiertan los sentidos y generan una atmósfera envolvente de placer, bienestar y conexión.',
    ...
    array (
      ...
      'features' => array ( 0 => 'Técnicas especializadas', 1 => 'Ambiente íntimo y relajante', 2 => 'Máxima privacidad', 3 => 'Profesionales certificadas' ),
    ...
    array (
      ...
      'features' => array ( 0 => 'Show privado exclusivo', 1 => 'Baile sensual y elegante', 2 => 'Juego de miradas y actitud', 3 => 'Atmósfera íntima y seductora' ),
    ...
    array (
      ...
      'features' => array ( 0 => 'Striptease privado', 1 => 'Experiencia íntima en la ducha', 2 => 'Masaje cuerpo a cuerpo PLUS', 3 => 'Copa de champagne incluida' ),
      'fullDescription' => 'Una experiencia exclusiva diseñada para quienes desean disfrutar de un momento completo de sensualidad, relajación y placer. Esta sesión combina un striptease privado, una experiencia íntima en la ducha y un masaje cuerpo a cuerpo PLUS, creando un ambiente envolvente y seductor. Todo acompañado de una copa de champagne para hacer de este momento algo aún más especial y memorable.',
      'image' => '/images/sensual_premium.webp',
    ),
    6 =>
    array (
      ...
      'features' => array ( 0 => 'Dos masajistas sincronizadas', 1 => 'Caricias simultáneas', 2 => 'Movimientos fluidos y envolventes', 3 => 'Placer profundo y relajación total' ),
    ...
    array (
      ...
      'features' => array ( 0 => 'Opción 1 o 2 masajistas', 1 => 'Caricias suaves y envolventes', 2 => 'Ambiente sensual y relajante', 3 => 'Conexión profunda en pareja' ),
